...
describe("DELETE /api/contacts/:contactId/addresses/:addressId", () => {
    ...
    it("should reject remove address if address id is not found", () => __awaiter(void 0, void 0, void 0, function* () {
        // ambil data contact dan address di database
        const contact = yield tes_utils_1.ContactTest.get();
        const address = yield tes_utils_1.AddressTest.get();
        const response = yield (0, supertest_1.default)(web_1.web)
    ...
    it("should reject remove address if contact id is not found", () => __awaiter(void 0, void 0, void 0, function* () {
        // ambil data contact dan address di database
        const contact = yield tes_utils_1.ContactTest.get();
        const address = yield tes_utils_1.AddressTest.get();
        const response = yield (0, supertest_1.default)(web_1.web)
